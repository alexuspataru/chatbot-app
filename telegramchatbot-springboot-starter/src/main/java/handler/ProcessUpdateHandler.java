...
public class ProcessUpdateHandler implements UpdatesListener{
	...
	@Autowired
	private AnotherMusicButtonAction anotherMusicButton;
	
	@Autowired
	private MusicCommandAction musicButton;
	...
	public void processUserMessages(Message message) {
		final String messageText = message.text();
			...
			case MenuUtils.ANOTHER_MUSIC: {
				anotherMusicButton.execute(telegramBot, message);
				break;
			}
		
		
			case MenuUtils.MUSIC: {
				musicButton.execute(telegramBot, message);
				break;
			}
